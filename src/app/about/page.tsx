    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <div className="
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            {`To deliver accurate, timely, and unbiased news coverage of Rajgarh subdistrict and surrounding regions. We
                ...
                {/* Why Choose Us */}
                <div className="mb-12">
                    <h2 className="text-3xl font-bold text-foreground mb-8">Why Choose Trisari aankh news Rajgarh</h2>
